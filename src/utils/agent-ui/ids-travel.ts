...
export const agentUiIdsTravel = {
  travel: {
    ...
    map: {
      open: 'ontrack.travel.map.open',
      close: 'ontrack.travel.map.close',
      world: 'ontrack.travel.map.section.world',
      globe: 'ontrack.travel.map.section.globe',
      flatWorld: 'ontrack.travel.map.section.flatWorld',
      country: 'ontrack.travel.map.section.country',
      portrait: 'ontrack.travel.map.layout.portrait',
      ...
      countryList: 'ontrack.travel.map.countryList',
      countryListToggle: 'ontrack.travel.map.countryList.toggle',
      countryListItem: (code: string) =>
        `ontrack.travel.map.countryList.item.${code}`,
      ...
      orientationHint: 'ontrack.travel.map.orientationHint',
      pinTrip: 'ontrack.travel.map.pinPlace.trip',
      pinTripNone: 'ontrack.travel.map.pinPlace.trip.none',
      pinSearch: 'ontrack.travel.map.pinPlace.search',
      pinSearchResult: (index: number) =>
        `ontrack.travel.map.pinPlace.searchResult.${index}`,
      pinOnMap: 'ontrack.travel.map.pinPlace.onMap',
      pinMapTarget: 'ontrack.travel.map.pinPlace.mapTarget',
      pinLabel: 'ontrack.travel.map.pinPlace.label',
      pinSave: 'ontrack.travel.map.pinPlace.save',
      place: (pinId: string) => `ontrack.travel.map.place.${pinId}`,
      countryCluster: (code: string) => `ontrack.travel.map.cluster.${code}`,
      preview: 'ontrack.travel.map.preview',
      previewOpenTrip: 'ontrack.travel.map.preview.openTrip',
      previewUnpin: 'ontrack.travel.map.preview.unpin',
      ...
      suggestionSkip: 'ontrack.travel.map.suggestion.skip',
    },
