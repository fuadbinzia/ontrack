import { googleDriveUploadSession } from '@/services/backup/google-drive-server';
...
export async function POST(request: Request) {
  return withGoogleCalendarApiAuth(request, {
    ...
    errorFallback: 'Google Drive could not prepare an upload.',
  }, async (_request, userId) => googleDriveUploadSession(userId));
}
