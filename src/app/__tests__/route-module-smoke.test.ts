...
const routeModules = [
  ...
  'src/app/(tabs)/(today)/detail/plant/[id].tsx',
...
const apiModules = [
  ...
  'src/app/api/events/search+api.ts',
  'src/app/api/events/ufc-athletes+api.ts',
  'src/app/api/events/sync+api.ts',
  'src/app/api/events/targets+api.ts',
  'src/app/api/events/ufc-live+api.ts',
