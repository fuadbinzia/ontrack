...
export const agentUiIdsJournal = {
  journal: {
    ...
    hub: 'ontrack.journal.hub',
    hubEmpty: 'ontrack.journal.hub.empty',
    pages: 'ontrack.journal.hub.pages',
    openToday: 'ontrack.journal.openToday',
    page: (dateKey: string) => `ontrack.journal.page.${dateKey}`,
    earlier: 'ontrack.journal.hub.pages',
    earlierPage: (dateKey: string) => `ontrack.journal.page.${dateKey}`,
