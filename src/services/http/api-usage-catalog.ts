...
export const API_USAGE_CATALOG: readonly ApiUsageCatalogEntry[] = [
  ...
  {
    id: 'gemini-journal-transcribe',
    name: 'Gemini (journal dictate)',
    provider: 'Google Generative Language',
    usedBy: ['Journal voice-to-text'],
    metering: 'app-rate-limit',
    bucket: 'journal',
    configKey: 'gemini',
    guardNames: ['gemini-journal'],
    healthProbe: { kind: 'gemini' },
  },
  {
    id: 'gemini-agents',
    name: 'Gemini (onTrack companion)',
    provider: 'Google Generative Language',
    usedBy: ['Dock search companion'],
    metering: 'app-rate-limit',
    bucket: 'agents',
    configKey: 'gemini',
    guardNames: ['gemini-journal'],
  ...
  {
    id: 'openai-agents',
    name: 'OpenAI (onTrack companion)',
    provider: 'OpenAI Responses',
    usedBy: ['Dock search companion (fallback)'],
    metering: 'app-rate-limit',
    bucket: 'agents',
    configKey: 'openai',
    guardNames: ['openai'],
  ...
  },
  {
    ...
    usedBy: ['Journal voice-to-text (optional paid override)'],
    metering: 'app-rate-limit',
    bucket: 'journal',
    limitNote: 'Used only when JOURNAL_TRANSCRIBE_PROVIDER=openai.',
    configKey: 'openai',
    guardNames: ['openai'],
    healthProbe: { kind: 'openai' },
  },
  {
    ...
    name: 'Google Gemini',
    provider: 'Google Generative Language',
    usedBy: ['Travel confirmation import (flights / stays / rentals)', 'Journal voice-to-text'],
    metering: 'app-rate-limit',
    bucket: 'flights',
